...
public class PlantModel {
    String Image, PlantName, Scientific, Origin, CommonIn, CareLvl, PlantType, MaxHeight, FloweringSeason, ToxicFor,
            Temperature, Lighting, Humidity, WateringFrequency, Fertilizer, Propagation, Pruning, Repotting, PlantDepth;
    PlantModel(){
    ...
    public PlantModel(String plantImg, String plantName, String plantScientific, String plantOrigin, String plantCommon, String plantCarelvl, String plantType,
                      ...
                      String plantFertilizer, String plantPropagation, String plantPruning, String plantRepot, String plantDepth) {
